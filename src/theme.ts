    ...
    MuiContainer: {
      styleOverrides: {
        root: {
          ...
          boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.05), inset 0 1px 0 0 rgba(255, 255, 255, 0.8)",
        },
      },
    },
    MuiButton: {
      styleOverrides: {
        ...
        contained: {
          ...
          boxShadow: "0 8px 32px rgba(59, 130, 246, 0.25), inset 0 1px 0 0 rgba(255, 255, 255, 0.4)",
          color: "rgba(255, 255, 255, 0.95)",
          "&:hover": {
            background: "linear-gradient(135deg, rgba(96, 165, 250, 0.9) 0%, rgba(59, 130, 246, 0.9) 100%)",
            boxShadow: "0 12px 40px rgba(59, 130, 246, 0.35), inset 0 1px 0 0 rgba(255, 255, 255, 0.5)",
          },
        },
        outlined: {
          ...
          backdropFilter: "blur(10px)",
          boxShadow: "0 4px 16px rgba(0, 0, 0, 0.05), inset 0 1px 0 0 rgba(255, 255, 255, 0.6)",
          color: "rgba(59, 130, 246, 0.9)",
          "&:hover": {
            background: "rgba(59, 130, 246, 0.08)",
            border: "1px solid rgba(59, 130, 246, 0.6)",
            boxShadow: "0 8px 24px rgba(59, 130, 246, 0.15), inset 0 1px 0 0 rgba(255, 255, 255, 0.7)",
          },
        },
        text: {
    ...
    MuiList: {
      styleOverrides: {
        root: {
          ...
          border: "1px solid rgba(148, 163, 184, 0.2)",
          padding: "16px",
          boxShadow: "0 8px 32px rgba(0, 0, 0, 0.08), inset 0 1px 0 0 rgba(255, 255, 255, 0.7)",
        },
      },
    },
    MuiTypography: {
